...
<body class="hold-transition login-page" style="background: url(img/fondo.jpg) no-repeat 0px 0px; background-size: cover; height: auto;">
    ...
    <div class="login-box">
        <div class="login-box-body" style="border: #e4e4e4 solid 1px;">
            ...
            <p class="login-box-msg" style="font-size: 25px;color: #00a65a;"><b>Recuperar Contraseña</b></p>

            {!! Form::open(array('url' => 'recupass', 'method' => 'POST')) !!}

            <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }} has-feedback">
                <input type="text" class="form-control" placeholder="Email" name="email" value="{{ old('email') }}" autofocus required>
