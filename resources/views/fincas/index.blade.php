                                    ...
                                    <td class="text-right">
                                        <div class="dropdown"><a href="#" class="action-icon dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><i class="fa fa-ellipsis-v"></i></a>
                                            <ul class="dropdown-menu pull-right">
                                                <li><a href="{{ url('verfinca/'.$finca->id) }}">Ver</a></li>
                                                <li><a href="{{ url('editfinca/'.$finca->id) }}">Editar</a></li>
                                                <li><a href="{{ url('asociarsuper/'.$finca->id) }}">Supervisor</a></li>
                                                <li><a href="{{ url('admincosecha/'.$finca->id) }}">Cosechas</a></li>
                                            </ul>
                                        </div>
                                    </td>
                                </tr>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Agregar Finca</h4>
                </div>
                {{ Form::open(['url' => ['registrarfinca'], 'method' => 'POST', 'files' => true]) }}
                <div class="modal-body">
                    @include('fincas.partials.formregistro')
                </div>
