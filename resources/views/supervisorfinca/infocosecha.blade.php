                            ...
                            <div class="row" style="margin-top: 10px;">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        {{ Form::text('fecha',$cosecha->fecha,['class' => 'form-control', 'placeholder'=>'', 'required'=>'required', 'disabled']) }}
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="aspecto" class="form-control-label"><b>Aspecto <span style="color: red;"> *</span></b></label>
                                        {{ Form::text('aspecto',$cosecha->aspecto,['class' => 'form-control', 'placeholder'=>'', 'required'=>'required', 'disabled']) }}
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="color" class="form-control-label"><b>Color <span style="color: red;"> *</span></b></label>
                                        {{ Form::text('color',$cosecha->color,['class' => 'form-control', 'placeholder'=>'', 'required'=>'required', 'disabled']) }}
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="porcefrutomaduro" class="form-control-label"><b>% fruto maduro <span style="color: red;"> *</span></b></label>
                                        {{ Form::text('porcefrutomaduro',$cosecha->porcefrutomaduro,['class' => 'form-control', 'placeholder'=>'', 'required'=>'required', 'disabled']) }}
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="porcefrutodañadobroca" class="form-control-label"><b>% fruto dañado<span style="color: red;"> *</span></b></label>
                                        {{ Form::text('porcefrutodañadobroca',$cosecha->porcefrutodañadobroca,['class' => 'form-control', 'placeholder'=>'', 'required'=>'required', 'disabled']) }}
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="tiposrecoleccion" class="form-control-label"><b>Tipo recolección<span style="color: red;"> *</span></b></label>
                                        {{ Form::text('tiposrecoleccion',$cosecha->tiposrecoleccion,['class' => 'form-control', 'placeholder'=>'', 'required'=>'required', 'disabled']) }}
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="condicionesclimaticas" class="form-control-label"><b>Condiciones climaticas<span style="color: red;"> *</span></b></label>
                                        {{ Form::text('condicionesclimaticas',$cosecha->condicionesclimaticas,['class' => 'form-control', 'placeholder'=>'', 'required'=>'required', 'disabled']) }}
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="nombreresponsable" class="form-control-label"><b>Responsable<span style="color: red;"> *</span></b></label>
                                        {{ Form::text('nombreresponsable',$cosecha->nombreresponsable,['class' => 'form-control', 'placeholder'=>'', 'required'=>'required', 'disabled']) }}
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        @if($cosecha->imagen)
                                            <img src="{{ asset($cosecha->imagen) }}" class="img-responsive" alt="" style="width: 250px;">
                                        @endif
                                    </div>
                                </div>
                            </div>                            
